...
export default function Login() {
  ...
  return (
    <Card className="relative overflow-hidden max-w-[500px] w-full mx-auto mt-[180px]">
      ...
      <CardFooter>
        <Button className="w-full bg-black cursor-pointer text-lg py-5">Sign In</Button>
      </CardFooter>
    </Card>
  );
}
